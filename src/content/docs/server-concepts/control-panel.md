...
See [Integration Service](/rev23-desktop-docs/server-concepts/integration-service/).

## Virtual Receptionist Service

See [Virtual Receptionist Service](/rev23-desktop-docs/server-concepts/virtual-receptionist-service/).
