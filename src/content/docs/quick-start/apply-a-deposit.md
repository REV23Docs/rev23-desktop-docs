---
title: "Quick Start: Apply a deposit"
sidebar:
  label: "Apply a deposit"
  order: 12
---
...
We will use the same steps as when we [started a sale](/rev23-desktop-docs/quick-start/start-a-sale/) for the walk-in piercing yesterday.
