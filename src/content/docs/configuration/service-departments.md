...
sidebar:
  ...
  order: 13
---
Service Departments are a higher-level group for your service types. The purpose of service departments is to group similar service types without using the hierarchical Service Categories.
