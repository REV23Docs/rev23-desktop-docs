...
See [Date/Time Format Codes](/rev23-desktop-docs/configuration/date-time-format-codes/) for more information about Invoice Number and Service Number Date/Time Formats.
...
Note: This property is only visible if the Create a subfolder containing the service date checkbox is checked. See [Date/Time Format Codes](/rev23-desktop-docs/configuration/date-time-format-codes/) for more information.
