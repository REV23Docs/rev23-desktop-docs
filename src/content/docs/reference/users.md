...
**Add Signature:** Captures the artist's signature from the signature pad. If a signature for this user exists, it will be added to the Consent Form automatically, regardless of the setting to require artist signatures in [My Studio: Options: Signature Pad Options](/rev23-desktop-docs/configuration/my-studio/#signature-capture-options).
