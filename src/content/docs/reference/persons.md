...
**Mobile Provider:** The person's SMS gateway, previously used to send text messages. [REV23 Desktop can no longer send text messages](/rev23-desktop-docs/how-to/create-twilio-account/).
