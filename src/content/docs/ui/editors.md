...
**Webcam:** Take a picture using your PC's webcam. By default, REV23 Desktop will use the first webcam it can find. You can set your default webcam in [Device Options](/rev23-desktop-docs/configuration/device-options/).
...
**Scan:** Initializes your TWAIN compatible scanner to scan an image. By default, REV23 Desktop will prompt you for which scanner you'd like to use. You can set your default scanner in [Device Options](/rev23-desktop-docs/configuration/device-options/) to avoid this prompt.
