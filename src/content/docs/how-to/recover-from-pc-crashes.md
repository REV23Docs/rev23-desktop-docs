---
title: "How to: Recover from PC crashes"
sidebar:
  label: "How to: Recover from PC crashes"
  order: 7
---
...
If you're able to recover a backup file you can proceed with [Restoring your database](/rev23-desktop-docs/how-to/restore-your-database/).
