---
title: "How To: Add Required Fields"
sidebar:
  label: "How to: Add required fields"
  order: 2
---
...
- [Configuration: Required Field Rules](/rev23-desktop-docs/configuration/required-field-rules/)
