---
title: "Quick Start Vol 2: Add a new service type"
sidebar:
  label: "Add a new service type"
  order: 6
---
...
5. Create the document that will become the template. See [Templates](/rev23-desktop-docs/concepts/templates/) or [Modify Consent Form](/rev23-desktop-docs/quick-start/modify-consent-form/) for guidance.
...
[Add Zatanna as a Service Provider](/rev23-desktop-docs/quick-start/add-a-tattooer/) for the Tattoo Removal service type, giving her a **Commission Percentage** of `80%`.
