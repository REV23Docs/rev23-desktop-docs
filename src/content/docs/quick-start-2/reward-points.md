---
title: "Quick Start Vol 2: Reward points"
sidebar:
  label: "Reward clients with points"
  order: 3
---
...
After a customer has earned enough points they will be redeemed for a credit that can be used just like a [Deposit/Credit](/rev23-desktop-docs/concepts/deposits-and-credits/).
