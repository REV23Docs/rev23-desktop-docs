...
2. Select a **Reason** and click **OK**.
    > You can add additional Walk-out Reasons using the New action in the lookup list view, or by navigating to [Configuration > Walk-out Reasons](/rev23-desktop-docs/configuration/walk-out-reasons/).
...
- [Concepts: Dashboards](/rev23-desktop-docs/concepts/dashboards/)
- [Concepts: Reports](/rev23-desktop-docs/concepts/reports/)
- [Reference: Walk-outs](/rev23-desktop-docs/reference/walk-outs/)
- [Configuration: Walk-out Reasons](/rev23-desktop-docs/configuration/walk-out-reasons/)
